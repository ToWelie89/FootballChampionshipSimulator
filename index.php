...
<html xmlns="http:/www.w3.org/1999/xhtml">
    ...
    <body>
        ...
        <div id="tournamentCompleteContainer">
            <p>
                You are done predicting results for the World Cup 2014.<br><br>
        ...
        <div id="main">
            <div id="shareButton">
                <div class="fb-share-button" data-href="http://83.254.69.223/WC2014/index.php" data-type="button_count" style="float: right;"></div>
            </div>
